...
elseif($msg=="fail"){
    ...
    ?>
        ...
        <div class="innerdiv">
            ...
            <div><label>Branch:</label><input type="radio" name="branch" value="other"/>Other<input type="radio" name="branch" value="BSIT"/>IT<div style="margin-left:80px"><input type="radio" name="branch" value="BSCS"/>CS<input type="radio" name="branch" value="BSSE"/>ECE</div>
            </div>   
